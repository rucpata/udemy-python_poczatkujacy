...
while year<maxTimeYears:
    ...
    print('the total revenues is', capital-intialCapital)
...
while True:
    ...
    if letter=='0':
        break
    input('You need to make a voild choice. Press ENTER and try again!')
